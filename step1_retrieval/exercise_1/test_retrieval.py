...
from step1_retrieval.exercise_1 import simple_retrieval_exercise as simple_retrieval
from step1_retrieval.exercise_1.simple_retrieval_exercise import preprocess
